...
PLOT_PATH = Path(PROJECT_HOME) / "out" / FUZZER_NAME / "plot_data"
...
if model == "deepseek":
    ...
    API_KEY = "sk-f42296797a7147c4b1089a58ba12abd6"
    BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
    if model == "qwen-turbo":
        MODEL = "qwen-turbo"
    elif model == "qwen-long":
        MODEL = "qwen-long"
elif "kimi" in model:
    MODEL = "kimi-k2-0711-preview"
    BASE_URL = "https://api.moonshot.cn/v1"
    API_KEY = "sk-dOWlTxsN0XDFeGLVDxaGqgMzBd01lqj5pRwnaSxPEvsGI8j5"
MAX_TIME = 3
