    ...
    class TagTable(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(self.tag_count):
                ...
                self.tags.append(Icc4.TagTable.TagDefinition(self._io, self, self._root))
        ...
        class TagDefinition(KaitaiStruct):
            ...
            class ChromaticityType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.number_of_device_channels):
                        ...
                        self.ciexy_coordinates_per_channel.append(Icc4.TagTable.TagDefinition.ChromaticityType.CiexyCoordinateValues(self._io, self, self._root))
            ...
            class ColorantTableType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.count_of_colorants):
                        ...
                        self.colorants.append(Icc4.TagTable.TagDefinition.ColorantTableType.Colorant(self._io, self, self._root))
            ...
            class MultiLocalizedUnicodeType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.number_of_records):
                        ...
                        self.records.append(Icc4.TagTable.TagDefinition.MultiLocalizedUnicodeType.Record(self._io, self, self._root))
            ...
            class MultiProcessElementsType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.number_of_processing_elements):
                        ...
                        self.process_element_positions_table.append(Icc4.PositionNumber(self._io, self, self._root))
            ...
            class NamedColor2Type(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.count_of_named_colours):
                        ...
                        self.named_colour_definitions.append(Icc4.TagTable.TagDefinition.NamedColor2Type.NamedColourDefinition(self._io, self, self._root))
            ...
            class ProfileSequenceDescType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.number_of_description_structures):
                        ...
                        self.profile_descriptions.append(Icc4.TagTable.TagDefinition.ProfileSequenceDescType.ProfileDescription(self._io, self, self._root))
            ...
            class ProfileSequenceIdentifierType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.number_of_structures):
                        ...
                        self.positions_table.append(Icc4.PositionNumber(self._io, self, self._root))
                    ...
                    for i in range(self.number_of_structures):
                        ...
                        self.profile_identifiers.append(Icc4.TagTable.TagDefinition.ProfileSequenceIdentifierType.ProfileIdentifier(self._io, self, self._root))
            ...
            class S15Fixed16ArrayType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    while not self._io.is_eof():
                        ...
                        self.values.append(Icc4.S15Fixed16Number(self._io, self, self._root))
            ...
            class U16Fixed16ArrayType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    while not self._io.is_eof():
                        self._debug['values']['arr'].append({'start': self._io.pos()})
                        self.values.append(Icc4.U16Fixed16Number(self._io, self, self._root))
                        self._debug['values']['arr'][len(self.values) - 1]['end'] = self._io.pos()
                        i += 1
            ...
            class XyzType(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    while not self._io.is_eof():
                        self._debug['values']['arr'].append({'start': self._io.pos()})
                        self.values.append(Icc4.XyzNumber(self._io, self, self._root))
                        self._debug['values']['arr'][len(self.values) - 1]['end'] = self._io.pos()
                        i += 1
