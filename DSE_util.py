...
class DSEUtil:
    ...
    def dse_runner(self, seed, code, line):
        ...
        os.makedirs(DSE_TMP_PATH, exist_ok=True)
        docker_seed_path = Path("/root/Project") / OUTPUT_DIR_NAME / "default" / "queue" / seed
        env = {"SYMCC_ENABLE_LINEARIZATION": "1",
               "SYMCC_INPUT_FILE": os.fspath(docker_seed_path),
